...
abstract class AppLocalizations {
  ...
  /// No description provided for @sortBySpecies.
  ///
  /// In en, this message translates to:
  /// **'Species'**
  String get sortBySpecies;
  ...
  /// No description provided for @failedToLoadLocalCharacters.
  ///
  /// In en, this message translates to:
  /// **'Error loading local data.'**
  String get failedToLoadLocalCharacters;
}
